<div wire:poll class="text-[7px] md:text-[10px] lg:text-[12px] xl:text-[14px] 2xl:text-[16px]">
    ...
    <div class="flex justify-evenly text-center text-2xl mb-8 border-b-2 border-black dark:border-white">
        <button wire:click="viewadmin">Vista admin</button>
        ...
        <div>
            ...
            <div class="text-gray-900 dark:text-gray-100 text-center">
                <form wire:submit="submitform" action="#">
                    ...
                    <button wire:click.prevent="resetfiltersadmin" class="mb-8 btn-default overflow-hidden relative bg-green-200 dark:bg-green-600 dark:text-white text-gray-900 p-2 rounded-lg font-bold uppercase transition-all duration-100 -- hover:shadow-md border border-green-100 dark:border-gray-700 hover:bg-gradient-to-t hover:from-green-300 before:to-green-50 hover:dark:from-green-900 before:dark:to-green-700 hover:-translate-y-[3px]">
                    ...
                    <div class="w-full">
                        ...
                        <div class="space-y-4 ">
                            ...
                            <div class="text-center justify-center flex gap-4">
                                <button wire:click="openSelfEditAbsence" class="btn-default overflow-hidden relative bg-yellow-300 dark:bg-yellow-300 text-gray-900 p-2 rounded-lg font-bold uppercase transition-all duration-100 -- hover:shadow-md border border-yellow-300 hover:bg-gradient-to-t  hover:from-yellow-400 before:to-yellow-100 hover:-translate-y-[3px]">
                                    Editar
                                </button>
    ...
    <!--Admin view (Insert teacher)-->
        <div class="text-center">
            <form action="">
                ...
                <button wire:click.prevent="insertTeacher" class="mb-8 btn-default overflow-hidden relative bg-green-200 dark:bg-green-600 dark:text-white text-gray-900 p-2 rounded-lg font-bold uppercase transition-all duration-100 -- hover:shadow-md border border-green-100 dark:border-gray-700 hover:bg-gradient-to-t hover:from-green-300 before:to-green-50 hover:dark:from-green-900 before:dark:to-green-700 hover:-translate-y-[3px]">Insertar Profesor</button>
            </form>
            @if ($inserterror)
                <p class="mb-6 text-red-600">Rellene todos los campos para insertar ausencias</p>   
            @endif
            @if ($admininserted)
                <p class="mb-6 text-red-600">SE HA INTENTADO INGRESAR UN ADMIN</p>   
            @endif
            @if ($createdt)
                <p class="mb-6 text-green-600">Se ha creado al profesor con éxito</p>   
            @endif
        </div>
    @endif
</div>
