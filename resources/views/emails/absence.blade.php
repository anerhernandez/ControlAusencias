...
<body>
    <div class="container">
        ...
        <div class="details">
            <p><strong>Usuario:</strong> {{ $absenceData['user_id'] }}</p>
            {{-- <p><strong>Departamento:</strong> {{ $absenceData['department_id'] }}</p> --}}
            <p><strong>Fecha:</strong> {{ $absenceData['date'] }}</p>
            <p><strong>Horario:</strong> {{ $absenceData['time'] }}</p>
            <p><strong>Comentarios:</strong> {{ $absenceData['comment'] }}</p>
            {{-- <p><strong>Fecha de creacíon:</strong> {{ $absenceData['created_at'] }}</p> --}}
        </div>
